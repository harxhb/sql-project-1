...
COPY hmda_2017_nj_all_records_labels
FROM '/common/home/cvm53/Downloads/hmda_2017_nj_all-records_labels.csv'
DELIMITER ','
CSV HEADER;

\copy Preliminary FROM '/common/home/cvm53/Downloads/hmda_2017_nj_all-records_labels.csv' WITH (FORMAT csv, HEADER, DELIMITER ',');
